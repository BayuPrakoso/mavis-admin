<?php 
  ...
  if( isset($_POST['submit']) ) {
    ...
    $controller->insertDestination($itm);
        ...
        $(function(){
            var mapDiv = document.getElementById('map');
                var map = new google.maps.Map(mapDiv, {
                  center: new google.maps.LatLng(-7.9775346, 112.6349141),
                  zoom: 10,
                ...
                <div class="col-md-7">
                  ...
                  <form action="" method="POST">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Location Name" name="name" required>
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input type="text" class="form-control" placeholder="Harga Tiket" name="email">
                      </div>
                      ...
                      <div class="input-group">
                        <span class="input-group-addon"></span>
                        <textarea type="text" class="form-control" placeholder="Rekomendasi Transport" name="transport" id="details"></textarea>
                      </div>
                      ...
                      <div class="input-group" style="width:100%;" >
                        <select class="form-control" style="width:100%;" name="featured">
                          ...
                          <option value="1">Location Featured</option>
                          <option value="0">Location Not Featured</option>
                        </select>
                      </div>
