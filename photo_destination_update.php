<?php 
  ...
  if($photo_id != null) {
        ...
        if( isset($_POST['url_upload']) ) {
          ...
          $itm->destination_id = $photo->destination_id;
          $itm->photo_id = $photo->photo_id;

          $controller->updatePhoto($itm);

          $viewUrl = $extras->encryptQuery1(KEY_SALT, 'destination_id', $photo->destination_id, 'photo_destination_view.php');
    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Update Location Photo</h3>
        </div>
