...
class ControllerAuthentication
{
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_mavis_authentication( username, password, name, role_id ) 
    ...
    public function updateAccessUser($itm) 
    {
        ...
        $stmt = $this->pdo->prepare('UPDATE tbl_mavis_authentication 
                                        SET 
                                            username = :username,
                                            password = :password,
                                            name = :name
