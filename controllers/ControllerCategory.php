...
{ 
    ...
    public function updateCategory($itm) 
    {
        ...
        $stmt = $this->pdo->prepare('UPDATE tbl_mavis_categories 
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_mavis_categories( category ) 
                                        VALUES( :category )');
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                        FROM tbl_mavis_categories WHERE category_id = :category_id');
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                        FROM tbl_mavis_categories WHERE category = :category');
