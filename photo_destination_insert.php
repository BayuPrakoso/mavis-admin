<?php 
  ...
  $extras = new Extras();
  $id_lokasi = $extras->decryptQuery1(KEY_SALT, $_SERVER['QUERY_STRING']);
  ...
  if( isset($_POST['file_upload']) ) {
      ...
      if( !empty($_FILES["file"]["name"][0]) && !empty($_FILES["file"]["name"][1]) ) {
          uploadFile($controller,$id_lokasi);
      }
      else {
...
<?php 
  ...
  function uploadFile($controller, $id_lokasi) {
    ...
    <div class="container">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">Add Location Photo</h3>
        </div>
